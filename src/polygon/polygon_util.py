...
for ind, fit in inds:
    print(fit)
    poly_fit = poly_list[ind]
    for poly in [poly1, poly_fit]:
        x_p,y_p = poly.exterior.xy
        plt.plot(x_p,y_p)
...
"""
image = Image.new("RGB", (npx, npy), "#ffffff")
draw = ImageDraw.Draw(image)



xc, yc, rc = 0,0,50
draw.ellipse([(xc-rc, yc-rc), (xc+rc, yc+rc)], fill = 'blue', outline ='blue')
"""
