...
def create_neb_task_file(path, init_path, final_path, path_dir_dump, timestep, spring_inter_replica=1.0, MaxE=0.0, nbMin=2000, nbClimb=2000, maxF=0.0, prnt=-1, minimize=False):
    try:
        os.remove(path)
    except:
        print("new file")
